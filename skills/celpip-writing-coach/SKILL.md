...
2. **Scores & Evidence**
3. **High-Impact Fixes**
4. **Pending Feedback Gate (Try-Fix First)**
5. **Guided Edit**
6. **Paraphrase Coach**
7. **Tangible Takeaways**
8. **Progress Compared With Prior Attempts** if a prior version exists
9. **Next Practice Plan**
...
- Mark acceptable lines `[keep]`; do not rewrite correct text.
- Use tags `[keep]`, `[replace]`, `[+add]`, `[-trim]`.
