...
- IELTS Academic Writing format: `https://ielts.org/organisations/ielts-for-organisations/test-types/ielts-academic-test/academic-test-format-in-detail`
...
- For a complete Writing test with both tasks: use a 2:1 coaching weighting because Task 2 contributes twice as much as Task 1. Estimate `(Task 1 + 2 * Task 2) / 3`, then round to the nearest 0.5.
- If evidence is thin, give a range such as `6.0-6.5`, not false precision.
...
- Format: `Problem -> Why it affects IELTS band -> Fix recipe -> Tiny before/after`.
...
For **Guided Edit**:
- Use a micro-edit table: `Original | Edit | Why | Tag`.
- Tags: `[keep]`, `[replace]`, `[+add]`, `[-trim]`.
...
- Use frames such as `Overall, ...`, `The most noticeable change is...`, `By contrast, ...`.
...
- Use direct purpose frames: `I am writing to request...`, `I am writing to express my concern about...`, `I am writing to let you know...`.
